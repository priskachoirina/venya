...
class Recipe extends MY_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        $this->page = 'Recipe';
        $this->dataapi = $this->apilib->recipe('GET');

        $this->data['title'] = 'Recipe';
        $this->data['key']   = 'recipe';
    }
    ...
    {                 
        ...
        $this->data['product']  = $this->apilib->products('GET');
        $this->data['material'] = $this->apilib->materials('GET');
		...
		$this->view('pusat/recipe_v',$this->data);
    } 
